...
class PageDataKehamilan extends StatefulWidget {
  const PageDataKehamilan({Key? key}) : super(key: key);

  @override
  _PageDataKehamilanState createState() => _PageDataKehamilanState();
}

class _PageDataKehamilanState extends State<PageDataKehamilan> {
                    ...
                    child: MaterialButton(
                      onPressed: () async {
                        if (formKey.currentState!.validate()) {
                          ...
                          await repository.postDataKehamilan(
                              id_pengguna,
                              _gravid.text,
                              _partus.text,
                              _abortus.text,
