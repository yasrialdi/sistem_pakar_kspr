...
class PageTambahDiagnosa extends StatefulWidget {
  const PageTambahDiagnosa({Key? key}) : super(key: key);

  @override
  State<PageTambahDiagnosa> createState() => _PageTambahDiagnosaState();
}

class _PageTambahDiagnosaState extends State<PageTambahDiagnosa> {
                    ...
                    child: MaterialButton(
                      onPressed: () async {
                        if (formKey.currentState!.validate()) {
                          ...
                          await repository.postDataTambahDiagnosa(
                            _kode.text,
                            _nama.text,
                            _deskripsi.text,
                            _solusi.text,
