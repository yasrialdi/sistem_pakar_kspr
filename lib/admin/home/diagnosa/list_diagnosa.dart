...
class PageListDataDiagnosa extends StatefulWidget {
  const PageListDataDiagnosa({Key? key}) : super(key: key);

  @override
  State<PageListDataDiagnosa> createState() => _PageListDataDiagnosaState();
}

class _PageListDataDiagnosaState extends State<PageListDataDiagnosa> {
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Kode Diagnosa\n'
                                            '${listDiagnosa[index].kode_diagnosa}',
                                        style: TextStyle(
                                          fontSize: 15,
                                          fontFamily: 'Ubuntu',
                                          color: Colors.black,
